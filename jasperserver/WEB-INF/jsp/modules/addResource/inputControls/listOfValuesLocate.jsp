...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
     <t:putAttribute name="pageTitle"><spring:message code="resource.listOfValues.locate.page.title"/></t:putAttribute>
    ...
    <t:putAttribute name="bodyContent">
        <form method="post">
            <t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
                ...
                <t:putAttribute name="containerTitle"><spring:message code='addResources.listOfValuesLocate.title' javaScriptEscape='true'/></t:putAttribute>
                ...
                <t:putAttribute name="bodyContent">
                    ...
                    <div id="stepDisplay">
                        <fieldset class="row instructions">
                            <legend class="offLeft"><span><spring:message code='addResources.listOfValuesLocate.instructions' javaScriptEscape='true'/></span></legend>
                            <h2 class="textAccent02"><spring:message code='addResources.listOfValuesLocate.locateListOfValues' javaScriptEscape='true'/></h2>
                            <h4><!--NOTE: keep h4 markup, but leave empty --></h4>
                            <%--<p class="warning">Error or warning here.</p>--%>
                        </fieldset>

                        <fieldset class="row inputs oneColumn">
                            <legend class="offLeft"><span><spring:message code='addResources.listOfValuesLocate.userInputs' javaScriptEscape='true'/></span></legend>
                            ...
                            <t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
                                ...
                                <t:putAttribute name="bodyContent">
                                    <fieldset class="locationSelector">
                                        <legend class="offLeft"><span><spring:message code='addResources.listOfValuesLocate.locateResource' javaScriptEscape='true'/></span></legend>
                                                ...
                                                <li id="fromRepo" class="leaf">
                                                    <div class="control radio complex">
                                                        <label class="wrap" for="CONTENT_REPOSITORY" title="<spring:message code='resource.report.repository'/>">
                                                            <spring:message code='addResources.listOfValuesLocate.selectListOfValues' javaScriptEscape='true'/>
                                                        </label>
                                                        <input id="CONTENT_REPOSITORY" name="${status.expression}" type="radio" value="CONTENT_REPOSITORY"
                                                                <c:if test='${status.value!="LOCAL"}'>checked="checked"</c:if> />
                                                    </div>
                                                    </spring:bind>
        ...
        <t:insertTemplate template="/WEB-INF/jsp/templates/selectFromRepository.jsp">
            ...
            <t:putAttribute name="bodyContent">
                <ul id="listOfValuesTreeRepoLocation"> </ul>
            </t:putAttribute>
        </t:insertTemplate>
